...
export default function InvestorDashboard() {
  ...
  const investMutation = useMutation({
    ...
    onSuccess: () => {
      toast({ title: "Investment Successful", description: "Your investment has been processed successfully." });
    ...
    onError: (error) => {
      ...
      toast({ title: "Investment Failed", description: "Failed to process your investment.", variant: "destructive" });
    },
  });
    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              <Users className="h-8 w-8 text-neutral-600 flex-shrink-0" />
              <div className="ml-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {approvedProjects.map((project: any) => {
                ...
                return (
                  <div
                    key={project.id}
                    className="border border-neutral-200 rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer"
          ...
          {myInvestments.length === 0 ? (
            ...
            <div className="space-y-4">
              {myInvestments.map((investment: any) => (
                <div
                  key={investment.id}
                  className="flex items-center justify-between p-4 border border-neutral-200 rounded-lg cursor-pointer hover:shadow-md transition-shadow"
